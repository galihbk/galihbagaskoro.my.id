...
3. Video final dikumpulkan dalam bentuk link YouTube
  `,
      ...
      {
        week: 3,
        title: "LANDASAN & PRINSIP MEDIA PEMBELAJARAN",
        file: "/files/media-pembelajaran/Media Pembelajaran Pertemua 3.pptx",
        url: "",
        showing: true,
      },
      {
        ...
        file: "/files/media-pembelajaran/Media Pembelajaran Pertemuan 4.pptx",
        url: "",
        showing: true,
      },
      {
        week: 5,
        title: "DESAIN MEDIA PEMBELAJARAN",
        file: "/files/media-pembelajaran/Media Pembelajaran Pertemua 5.pptx",
        url: "",
        showing: true,
      },
      {
        week: 6,
        title: "APLIKASI PRODUKSI MEDIA BERBASIS SOFTWARE",
        file: "/files/media-pembelajaran/Media Pembelajaran Pertemuan 6.pptx",
        url: "",
        showing: true,
      },
      {
        week: 7,
        title: "MULTIMEDIA DALAM PEMBELAJARAN",
        file: "/files/media-pembelajaran/Media Pembelajaran Pertemuan 7.pptx",
        url: "",
        showing: true,
      },
    ],
